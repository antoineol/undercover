...
export const UI_MESSAGES = {
  ...
  BUTTONS: {
    ...
    VALIDATE_GAME: "🔧 Valider le Jeu",
    VALIDATING: "⏳ Validation...",
    START_GAME: "Démarrer le Jeu",
    LEAVE_ROOM: "Quitter la Salle",
    SHARE_WORD: "Partager",
    VOTE_AGAINST: "Voter Contre",
    VOTED: "✅ Voté - Cliquer pour changer",
    RESTART_GAME: "🔄 Recommencer un nouveau jeu",
  },
  ERRORS: {
    ROOM_NOT_FOUND: "Salle introuvable. Vérifiez le code de la salle.",
    GAME_STARTED: "La partie a déjà commencé. Vous ne pouvez plus rejoindre cette salle.",
    ROOM_FULL: "La salle est pleine. Maximum 10 joueurs autorisés.",
    NAME_EXISTS: "Un joueur avec ce nom existe déjà dans la salle. Veuillez choisir un autre nom.",
    INVALID_SESSION: "Session invalide. Veuillez rejoindre avec un nouveau nom.",
    GENERIC_JOIN_ERROR: "Impossible de rejoindre la salle. Vérifiez le code de la salle ou essayez un nom différent.",
  },
} as const;
